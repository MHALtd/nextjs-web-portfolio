...
const projectsData = [
  {
    id: 1,
    title: "EnglishBuddy",
    description: "IELTS Responsive Website Test Frontend using React.js framework, Vite.js build tool and Tailwind",
  ...
  {
    id: 2,
    title: "Izumi JFT Evaluation",
    description: "Japanese Responsive Website Test using MERN Stack (MongoDB, Express, React, Node) and Tailwind",
    image: "/images/projects/2.png",
    gitUrl: "https://github.com/MHALtd/izumi-jft-eval.git",
    previewUrl: "https://izumi-jft-client.vercel.app/",
  },
  {
    id: 3,
    title: "Book Store",
    description: "CRUD Book Store using MERN Stack (MongoDB, Express, React, Node) and daisyUI",
